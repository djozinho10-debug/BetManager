...
def add_bet(data: dict):
    cols = [
        ...
        'telegram_result','telegram_result_message_id','bet_link'
    ]
...
def update_bet(bet_id: int, data: dict):
    cols=['user_name','bet_date','bookmaker','competition','country','event','market','selection','bet_type','timing','odds','units','notes','bet_link']
